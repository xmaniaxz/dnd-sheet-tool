...
export default function AbilityScoresPanel() {
  ...
  const [expanded, setExpanded] = useState<keyof typeof data.abilities | null>(
    null
  );
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="grid grid-cols-1 gap-1">
                            {skills.map(([skillKey, skillLabel]) => {
                              ...
                              return (
                                <div key={skillKey} className="flex items-center justify-between gap-2 group relative">
                                  <label className="flex items-center gap-2 text-xs ">
                                    <input
                                      type="checkbox"
                                      disabled={!editMode}
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="w-8 text-right text-xs ">{formatMod(total)}</span>
                                  </div>
